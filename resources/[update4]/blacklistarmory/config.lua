...
Config.Armory = { ["x"] = 1087.49, ["y"] = -3195.6, ["z"] = -38.99, ["h"] = 134.91 }
Config.ArmoryPed = { ["x"] = 1087.71, ["y"] = -3196.73, ["z"] = -38.99, ["h"] = 93.98, ["hash"] = "s_m_m_highsec_02" }
...
Config.ArmoryWeapons = {
	...
	{ ["hash"] = "WEAPON_BATTLEAXE", ["type"] = "pistol" },
