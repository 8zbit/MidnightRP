...
Config.CarGarages = {
	...
	Garage_Pearls = {
		GaragePoint = { x = -2033.04, y = -463.39, z = 11.42 },
	...
	Garage_RaceTrack = {
		...
		DeletePoint = { x = 1207.9, y = 343.8, z = 81.99 }
	},
	...
	Garage_cardealer = {
		GaragePoint = { x = -1151.57, y = -1705.21, z = 4.56 },
		SpawnPoint = { x = -1141.74, y = -1708.5, z = 4.28, h = 299.08 },
		DeletePoint = { x = -1161.4, y = -1721.77, z = 4.19 }
	},

	Garage_midnight = {
		GaragePoint = { x = 1022.19, y = -2291.23, z = 30.51 },
		SpawnPoint = { x = 1026.91, y = -2306.49, z = 30.52, h = 176.48 },
		DeletePoint = { x = 1038.14, y = -2289.16, z = 30.39 }
	},

	Garage_bennys = {
		GaragePoint = { x = -175.51, y = -1289.14, z = 31.3 },
		SpawnPoint = { x = -182.54, y = -1286.61, z = 31.3, h = 179.83 },
		DeletePoint = { x = -183.43, y = -1312.37, z = 31.3 }
	},
	
	Garage_SOA = {
		GaragePoint = { x = 984.27, y = -91.87, z = 74.85 },
		SpawnPoint = { x = 979.41, y = -115.08, z = 74.2, h = 135.27 },
		DeletePoint = { x = 967.58, y = -138.66, z = 74.39 }
	},

	Garage_dockside = {
		GaragePoint = { x = -3237.94, y = 996.15, z = 12.43 },
		SpawnPoint = { x = -3228.64, y =996.06, z = 12.45, h = 348.29 },
		DeletePoint = { x = -3243.98, y = 990.27, z = 12.49 }
	},

	Garage_flightschool = {
		GaragePoint = { x = -993.39, y = -2931.61, z = 13.96 },
		SpawnPoint = { x = -1008.19, y =-2921.02, z = 13.95, h = 13.78 },
		DeletePoint = { x = -1007.48, y = -2938.38, z = 13.95 }
	},
...
Config.CarPounds = {
	...
	Pound_cardealer = {
		PoundPoint = { x = -1157.81, y = -1730.64, z = 4.16 },
		SpawnPoint = { x = -1163.42, y = -1741.16, z = 4.03, h = 154.46 }
	},

	Pound_midnightclub = {
		PoundPoint = { x = 1011.6, y = -2339.44, z = 30.51 },
		SpawnPoint = { x = 990.0, y = -2335.4, z = 30.51, h = 175.75 }
	},


	Pound_Pearls = {
		PoundPoint = { x = -2028.44, y = -467.84, z = 11.41 },
		SpawnPoint = { x = -2024.71, y = -464.31, z = 11.49, h = 46.88 }
	},

	Pound_soa = {
		PoundPoint = { x = 978.35, y = -91.8, z = 74.85 },
		SpawnPoint = { x = 980.47, y = -113.26, z = 74.25, h = 133.96 }
	},
	...
	Pound_flightschool = {
		PoundPoint = { x = -1026.14, y = -3016.26, z = 13.95 },
		SpawnPoint = { x = -1038.92, y = -2999.23, z = 13.95, h = 62.48 }
	},
	Pound_Paleto = {
...
Config.BoatGarages = {
	Garage_LSDock = {
		...
		DeletePoint = { x = -729.99, y = -1336.43, z = -0.12477427124977 }
	},
	Garage_SandyDock = {
