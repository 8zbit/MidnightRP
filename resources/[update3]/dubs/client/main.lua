...
RegisterNetEvent("dubs:refreshVehicles")
AddEventHandler("dubs:refreshVehicles", function()
	RemoveVehicles()
...
function LoadSellPlace()
	Citizen.CreateThread(function()
		...
		AddTextComponentString("Dubbs_dealership")
...
function OpenSellMenu(veh, price, buyVehicle, owner)
	...
	function(data, menu)
		...
		elseif action == "sell" then
			...
			ESX.TriggerServerCallback("dubs:isVehicleValid", function(valid)
		...
		elseif action == "buy" then
			ESX.TriggerServerCallback("dubs:buyVehicle", function(isPurchasable, totalMoney)
...
function SpawnVehicles()
	...
	ESX.TriggerServerCallback("dubs:retrieveVehicles", function(vehicles)
