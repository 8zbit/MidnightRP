...

{
	...
	objCoords  = {x = -2247.886, y = -636.2828, z = 14.08084},
	textCoords = {x = -2247.886, y = -636.2828, z = 14.08084},
...
{
	objName = 'apa_v_ilev_fh_heistdoor1',
	objCoords  = {x = -2246.638, y = -610.3927, z = 14.0734},
	textCoords = {x = -2246.638, y = -610.3927, z = 14.0734},
	authorizedJobs = { 'pearls' },
	locked = true,
	distance = 2.5
},
...
---midnightclub
	{
		objName = 'prop_id2_11_gdoor',
		objCoords  = {x = 1033.587, y = -2299.42, z = 31.55749},
		textCoords = {x = 1033.587, y = -2299.42, z = 31.55749},
		authorizedJobs = { 'midnightclub' },
		locked = true,
		distance = 10.5,
		size = 2
	},
	...
	{
		objName = 'prop_id2_11_gdoor',
		objCoords  = {x = 998.9113, y = -2327.259, z = 31.58646},
		textCoords = {x = 998.9113, y = -2327.259, z = 31.58646},
		authorizedJobs = { 'midnightclub' },
		locked = true,
		distance = 10.5,
		size = 2
	...
	{
		objName = 'ex_prop_door_arcad_ent_r',
		objCoords  = {x = 1010.045, y = -2318.828, z = 35.80081},
		textCoords = {x = 1010.045, y = -2318.828, z = 35.80081},
		authorizedJobs = { 'midnightclub' },
		locked = true,
		distance = 4.5,
		size = 1.2
	...
	{
		objName = 'ex_prop_door_arcad_ent_r',
		objCoords  = {x = 1010.265, y = -2316.049, z = 35.80081},
		textCoords = {x = 1010.045, y = -2318.828, z = 35.80081},
		authorizedJobs = { 'midnightclub' },
		locked = true,
		distance = 4.5,
...
-----------------bank
...

	{
		...
		objCoords  = {x = 251.8576, y = 221.0655, z = 101.8324},
		textCoords = {x = 0.0, y = 0.0, z = -1000.0}, 
		authorizedJobs = { 'police' },
		locked = true
	},

	{
		...
		objCoords  = {x = 261.3004, y = 214.5051, z = 101.8324},
		textCoords = {x = 0.0, y = 0.0, z = -1000.0}, 
		authorizedJobs = { 'police' },
		locked = true
	},
...
{
	objName = 'v_ilev_rc_door2',
	objCoords  = {x = 1858.76, y = 3691.17, z = 34.4},
	textCoords = {x = 1858.76, y = 3691.17, z = 34.4},
	authorizedJobs = { 'police' },
	distance = 2.5,
	size = 1.2,
	locked = true
...

	{
		...
		objCoords  = {x = 96.091974, y = -1284.854, z = 29.438},
		textCoords = {x = 95.091974, y = -1284.854, z = 29.438},
...

	{
		...
		objCoords  = {x = 113.98220, y = -1297.43, z = 29.41868},
		textCoords = {x = 112.98220, y = -1297.43, z = 29.41868},
		authorizedJobs = { 'unicorn' },
		distance = 2.5,
		size = 1.2,
		locked = true
...

	{
		...
		objCoords  = {x = 127.95520, y = -1298.5, z = 29.41962},
		textCoords = {x = 128.95520, y = -1298.5, z = 29.41962},
		authorizedJobs = { 'unicorn' },
		distance = 2.5,
		size = 1.2,
		locked = true
