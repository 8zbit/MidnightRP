...
RCCar.HandleKeys = function(distanceCheck)
	...
	if distanceCheck < Config.LoseConnectionDistance then
		if IsControlPressed(0, 232) and not IsControlPressed(0, 196) then
		...
		if IsControlJustReleased(0, 232) or IsControlJustReleased(0, 196) then
			TaskVehicleTempAction(RCCar.Driver, RCCar.Entity, 6, 2500)
		end

		if IsControlPressed(0, 196) and not IsControlPressed(0, 232) then
			TaskVehicleTempAction(RCCar.Driver, RCCar.Entity, 22, 1)
		end

		if IsControlPressed(0, 234) and IsControlPressed(0, 196) then
			TaskVehicleTempAction(RCCar.Driver, RCCar.Entity, 13, 1)
		end

		if IsControlPressed(0, 195) and IsControlPressed(0, 196) then
			TaskVehicleTempAction(RCCar.Driver, RCCar.Entity, 14, 1)
		end

		if IsControlPressed(0, 232) and IsControlPressed(0, 196) then
			TaskVehicleTempAction(RCCar.Driver, RCCar.Entity, 30, 100)
		end

		if IsControlPressed(0, 234) and IsControlPressed(0, 232) then
			TaskVehicleTempAction(RCCar.Driver, RCCar.Entity, 7, 1)
		end

		if IsControlPressed(0, 195) and IsControlPressed(0, 232) then
			TaskVehicleTempAction(RCCar.Driver, RCCar.Entity, 8, 1)
		end

		if IsControlPressed(0, 234) and not IsControlPressed(0, 232) and not IsControlPressed(0, 196) then
			TaskVehicleTempAction(RCCar.Driver, RCCar.Entity, 4, 1)
		end

		if IsControlPressed(0, 195) and not IsControlPressed(0, 232) and not IsControlPressed(0, 196) then
