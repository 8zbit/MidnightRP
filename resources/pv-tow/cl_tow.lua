...
AddEventHandler('pv:tow', function()
	...
	if isVehicleTow then
		...
		if currentlyTowedVehicle == nil then
			if targetVehicle ~= 0 then
				if not IsPedInAnyVehicle(playerped, true) then
					if vehicle ~= targetVehicle then
						AttachEntityToEntity(targetVehicle, vehicle, 10, 0.7, -5.0, 0.5, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
			...
			AttachEntityToEntity(currentlyTowedVehicle, vehicle, 20, -0.5, -5.0, 1.0, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
