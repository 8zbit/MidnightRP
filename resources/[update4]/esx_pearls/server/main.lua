...
RegisterServerEvent('esx_pearls:craftingCoktails')
AddEventHandler('esx_pearls:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_pearls:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_pearls', function(store)
...
ESX.RegisterServerCallback('esx_pearls:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_pearls:removeVaultWeapon', function(source, cb, weaponName)
