...
local atms = {
	...
	{name="ATM", id=277, x=436.346, y=-985.832, z=30.689},
	{name="ATM", id=277, x=-1109.63, y=-1690.89, z=4.37},
	{name="ATM", id=277, x=315.19, y=-593.67, z=43.28},
	{name="ATM", id=277, x=-2241.05, y=-611.61, z=13.88},
...
if bankMenu then
	...
	if nearBank() or nearATM() then
		...
		if IsControlJustPressed(2, 322) then
		inMenu = false
