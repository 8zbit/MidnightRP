...
Config.CooldownMinutes    = 35 -- Minutes between chopping.
...
Config.NPCShop	          = { x = 470.9, y = -1901.53, z = 24.96, h = 276.4 } -- Location of the shop For the npc.
...
Config.Zones = {
    Chopshop = {coords = vector3(464.98,-1885.07,26.1), name = _U('map_blip'), color = 49, sprite = 225, radius = 100.0, Pos = { x = 464.98, y = -1885.07, z = 25.1 }, Size  = { x = 1.2, y = 1.2, z = 1.0 }, },
    Shop = {coords = vector3(470.9,-1901.53,24.96), name = _U('map_blip_shop'), color = 50, sprite = 120, radius = 100.0, Pos = {x = 470.9, y = -1901.53, z = 23.96}, Size  = { x = 1.2, y = 1.2, z = 1.0 }, },
}
