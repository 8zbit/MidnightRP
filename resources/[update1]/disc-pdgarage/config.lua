...
Config.PoliceVehicles = {
		...
		{ model = 'police', label = 'Police Stanier', price = 0 },
		{ model = 'police3', label = 'Police Interceptor', price = 0 },
		{ model = 'policet', label = 'Police Transport Van', price = 0 },
		{ model = 'police4', label = 'Undercover Police Stanier', price = 0 },
		{ model = 'sheriff', label = 'Sheriff Stanier', price = 0 },
		{ model = 'sheriff2', label = 'Sheriff Granger', price = 0 },
		{ model = 'fbi', label = 'FIB Buffalo', price = 0 },
		{ model = 'fbi2', label = 'FIB Granger', price = 0 },
		{ model = 'PBus', label = 'Prison Transport Van', price = 0 },
		{ model = 'sv2', label = 'Unmarked charger', price = 0 },
		{ model = 'lssdchgr', label = 'DOC 1', price = 0 },
		{ model = 'lssdfpis', label = 'DOC 2', price = 0 },
		{ model = 'lssdfpiu', label = 'DOC 3', price = 0 },
		{ model = 'lssdsilv18', label = 'DOC 4', price = 0 },
		{ model = 'lssdtahoe17', label = 'DOC 5', price = 0 },
		{ model = 'mcraptor', label = 'Offroad', price = 0 },
		{ model = 'policeb', label = 'Police Bike', price = 0 },
		{ model = 'polmav', label = 'Y99', price = 0 },
		{ model = 'pd2', label = 'police charger', price = 0 },
		{ model = 'pd4', label = 'police interceptor', price = 0 },
		{ model = 'pd8', label = 'unmarked taho', price = 0 },
		{ model = 'pd9', label = 'police caprice', price = 0 },
		{ model = 'unmarked1', label = 'FPIU Unmarked', price = 0 },
		{ model = 'unmarked2', label = 'Dodge Charger 2010', price = 0 },
		{ model = 'unmarked3', label = 'Toyota Camry Unmakred', price = 0 },
		{ model = 'unmarked4', label = 'Ford Mustang GT 2016', price = 0 },
		{ model = 'unmarked5', label = '2010 Ford F350', price = 0 },
		{ model = 'unmarked6', label = 'CVPI', price = 0 },
		{ model = 'unmarked7', label = '2012 FPIS', price = 0 },
		{ model = 'unmarked8', label = '2015 Tahoe', price = 0 },
		{ model = 'unmarked9', label = 'unmarked9', price = 0 },
...
Config.PoliceBoats = {
	...
	{ model = 'largeboat', label = 'Police largeboat', livery = 0, price = 0 },
	{ model = 'smallboat', label = 'Police smallboat', livery = 0, price = 0 },
