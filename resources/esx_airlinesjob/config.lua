...
Config.Zones = {
  airlinesActions = {
    Pos   = { x = -1240.14, y = -3001.81, z = -42.89 },
  ...
  Garage = {
    Pos   = { x = -1001.26, y = -2966.23, z = 13.95 },
    Size  = { x = 1.0, y = 1.0, z = 1.0 },
    Color = { r = 0, g = 0, b = 255 },
    Type  = 1,
  },
  ...
  Craft = {
    Pos   = { x = 1011.56, y = -2333.39, z = 30.51 },
    Size  = { x = 1.0, y = 1.0, z = 1.0 },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = -1035.3, y = -2966.43, z = 13.95 },
    Heading = 164.621,
  ...
  VehicleDeleter = {
    Pos   = { x = -1046.89, y = -2986.45, z = 13.95 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 0, b = 0 },
    Type  = 1,
  },
  ...
  VehicleDelivery = {
    Pos   = { x = -1074.31, y = -2987.32, z = 13.96 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = -1,
  },
