local text1 = "server restart in 15 minutes ! A 6h/12h/18h/00h"
local text2 = "server restart in 10 minutes ! A 6h/12h/18h/00h"
local text3 = "server restart in 5 minutes  ! A 6h/12h/18h/00h"
local text4 = "server restarting !"
