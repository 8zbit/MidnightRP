...
Citizen.CreateThread(function()
	while true do
      ...
      local zaplata = 0
				...
				--	if ESX.GetPlayerData().job.name == 'milkman' then
...
if(GetDistanceBetweenCoords(coords, 2512.740, 4761.850, 34.90, true) < 20.0) or (GetDistanceBetweenCoords(coords, 2500.960, 4800.750, 34.740, true) < 5.0) then
	...
	ESX.Game.Utils.DrawText3D({ x = 2512.870, y = 4761.850, z = 34.90 }, '~y~[E] ~w~Cloackroom', 0.6)	
			local coords      = GetEntityCoords(GetPlayerPed(-1))
...
local blips = {
	...
	{title="Dairy dressing room", colour=4, id=366, x = 2512.990, y = 4762.750, z = 34.90},
	{title="Dairy machine", colour=4, id=402, x = 2502.120, y = 4801.250, z = 43.740}
