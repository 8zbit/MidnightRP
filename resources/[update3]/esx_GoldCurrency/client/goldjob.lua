...
AddEventHandler("esx_goldCurrency:missionComplete", function(itemAmount1,item1,itemAmount2,item2)
	...
	if itemAmount2 or item2 then
		AnnounceString = "+You received: ~b~"..itemAmount1.."x~s~ ~y~"..item1.."~s~ and "..itemAmount2.."x~s~ ~y~"..item2.."~s~"
	else
		AnnounceString = "+You received: ~b~"..itemAmount1.."x~s~ ~y~"..item1.."~s~"
	end
    Citizen.Wait(5 * 1000)
...
function PoliceRobberyAlert()
    ...
    robbery_alert = 'I just saw a shootout and a van was being lockpicked'
