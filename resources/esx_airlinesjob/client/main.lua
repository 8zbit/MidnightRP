...
function StopNPCJob(cancel)
  ...
  if cancel then
    ...
    TriggerServerEvent('esx_airlinesjob:onNPCJobCompleted')
  end
    ...
    function(data, menu)
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            local elements = {
              {label = _U('Shamal'), value = 'Shamal'},
              {label = _U('Dodo'), value = 'Dodo'},
			        {label = _U('Vestra'), value = 'Vestra'},
              {label = _U('Velum'), value = 'rass'},
            ...
            if Config.EnablePlayerManagement and PlayerData.job ~= nil and
              ...
              table.insert(elements, {label = 'Shamal', value = 'Shamal'})
              table.insert(elements, {label = 'Dodo', value = 'Dodo'})
              table.insert(elements, {label = 'Vestra', value = 'Vestra'})
              table.insert(elements, {label = 'Velum', value = 'Velum'})
              table.insert(elements, {label = 'Nimbus', value = 'Nimbus'})
              table.insert(elements, {label = 'Volatus', value = 'Volatus'})
              table.insert(elements, {label = 'Swift', value = 'Swift'})
              table.insert(elements, {label = 'Frogger', value = 'Frogger'})
              table.insert(elements, {label = 'Duster', value = 'Duster'})
            end
...
function OpenairlinesHarvestMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name ~= 'recrue' then
    ...
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'airlines_harvest',
      {
        title    = _U('harvest'),
        align    = 'right',
        elements = elements
      ...
      function(data, menu)
        if data.current.value == 'gaz_bottle' then
          menu.close()
          TriggerServerEvent('esx_airlinesjob:startHarvest')
        end

        if data.current.value == 'fix_tool' then
          menu.close()
          TriggerServerEvent('esx_airlinesjob:startHarvest2')
        end

        if data.current.value == 'caro_tool' then
          menu.close()
          TriggerServerEvent('esx_airlinesjob:startHarvest3')
        end

      end,
      function(data, menu)
        menu.close()
        CurrentAction     = 'airlines_harvest_menu'
...
function OpenairlinesCraftMenu()
  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name ~= 'recrue' then
    ...
    ESX.UI.Menu.Open(
      'default', GetCurrentResourceName(), 'airlines_craft',
      {
        title    = _U('craft'),
        align    = 'right',
        elements = elements
      ...
      function(data, menu)
        if data.current.value == 'blow_pipe' then
          menu.close()
          TriggerServerEvent('esx_airlinesjob:startCraft')
        end

        if data.current.value == 'fix_kit' then
          menu.close()
          TriggerServerEvent('esx_airlinesjob:startCraft2')
        end

        if data.current.value == 'caro_kit' then
          menu.close()
          TriggerServerEvent('esx_airlinesjob:startCraft3')
        end

      end,
      function(data, menu)
        menu.close()
        CurrentAction     = 'airlines_craft_menu'
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
          ...
          function(data, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_airlines', _U('airlines'), amount)
              end
            end
          end,
        function(data, menu)
          ...
          if CurrentlyTowedVehicle == nil then
            ...
            if NPCOnJob then
              ...
              if CurrentlyTowedVehicle == NPCTargetTowable then
                ...
                TriggerServerEvent('esx_airlinesjob:onNPCJobMissionCompleted')
                StopNPCJob()
      ...
      if data.current.value == 'object_spawner' then
        ...
        ESX.UI.Menu.Open(
          'default', GetCurrentResourceName(), 'mobile_airlines_actions_spawn',
          {
            title    = _U('objects'),
            align    = 'right',
            elements = {
...
RegisterNetEvent('esx_airlinesjob:onHijack')
AddEventHandler('esx_airlinesjob:onHijack', function()
  local playerPed = GetPlayerPed(-1)
  local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_airlinesjob:onCarokit')
AddEventHandler('esx_airlinesjob:onCarokit', function()
  local playerPed = GetPlayerPed(-1)
  local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_airlinesjob:onFixkit')
AddEventHandler('esx_airlinesjob:onFixkit', function()
  local playerPed = GetPlayerPed(-1)
  local coords    = GetEntityCoords(playerPed)
...
AddEventHandler('esx_airlinesjob:hasExitedMarker', function(zone)
  ...
  if zone == 'Craft' then
    TriggerServerEvent('esx_airlinesjob:stopCraft')
    TriggerServerEvent('esx_airlinesjob:stopCraft2')
    TriggerServerEvent('esx_airlinesjob:stopCraft3')
  end

  if zone == 'Garage' then
    TriggerServerEvent('esx_airlinesjob:stopHarvest')
    TriggerServerEvent('esx_airlinesjob:stopHarvest2')
    TriggerServerEvent('esx_airlinesjob:stopHarvest3')
  end
...
AddEventHandler('esx_airlinesjob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'airlines' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_airlinesjob:hasExitedEntityZone', function(entity)
...
Citizen.CreateThread(function()
  ...
  AddTextComponentString(_U('airlines'))
...
Citizen.CreateThread(function()
    while true do
        ...
        if CurrentAction ~= nil then
          ...
          if IsControlJustReleased(0, 38) and PlayerData.job ~= nil and PlayerData.job.name == 'airlines' then

            if CurrentAction == 'airlines_actions_menu' then
                OpenairlinesActionsMenu()
            end

            if CurrentAction == 'airlines_harvest_menu' then
                OpenairlinesHarvestMenu()
            end

            if CurrentAction == 'airlines_craft_menu' then
                OpenairlinesCraftMenu()
            end
        ...
        if IsControlJustReleased(0, Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'airlines' then
            OpenMobileairlinesActionsMenu()
        end

        if IsControlJustReleased(0, Keys['DELETE']) and PlayerData.job ~= nil and PlayerData.job.name == 'airlines' then
