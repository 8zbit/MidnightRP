...
Config.SocietyUnicorn		= true -- Set to true if you want the money players pay to go into the nightclub society account

Config.PimpGuy = {
    { x= 113.76, y= -1294.51, z= 28.27, name = "Pimp", heading = 207.82, model = "s_m_m_bouncer_01" },
}

Config.Zones = {
	["Pimp"] = {
		Pos   = { x= 113.76, y= -1294.51, z= 28.27 },
	},
} 
