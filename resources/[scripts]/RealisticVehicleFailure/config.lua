...
cfg = {
	...
	weaponsDamageMultiplier = 5.0,				-- How much damage should the vehicle get from weapons fire. Range 0.0 to 10.0, where 0.0 is no damage and 10.0 is 10x damage. -1 = don't touch
	...
	cascadingFailureSpeedFactor = 8,			-- Sane values are 1 to 100. When vehicle health drops below a certain point, cascading failure sets in, and the health drops rapidly until the vehicle dies. Higher values means faster failure. A good starting point is 8
	...
	limpModeMultiplier = 0.08,					-- The torque multiplier to use when vehicle is limping. Sane values are 0.05 to 0.25
