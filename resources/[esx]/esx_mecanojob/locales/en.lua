Locales['en'] = {
  ...
  ['work_wear']                 = 'workwear',
  ['work_wear2']                = 'other workwear',
  ['civ_wear']                  = 'civilian clothes',
  ['deposit_stock']             = 'deposit Stock',
  ['withdraw_stock']            = 'withdraw Stock',
  ['boss_actions']              = 'boss Actions',
  ['service_vehicle']           = 'service Vehicle',
  ['flat_bed']                  = 'Standard Flatbed',
  ['flat_bed3']                 = 'Rollback Flatbed',
  ['tow_truck']                 = 'Lorry Flatbed',
  ['pickup']                    = 'Pickup Truck',
  ['Small Trailer']             = 'Small Trailer',
  ['Hauler Lorry']              = 'Hauler Lorry',
  ['Transport Trailer']         = 'Transport Trailer',
